...
void Graphics::DrawRightIsoTriUL(int top, int left, int size, Color c)
{
	int x_size = size;
	for (int y = top; y <= top + size - 1; y++)
	{
		x_size--;
		for (int x = left; x <= left + x_size; x++)
		{
			PutPixel(x, y, c);
		}
	}
...
void Graphics::DrawRightIsoTriUR(int top, int right, int size, Color c)
{
	int x_size = size;
	for (int y = top; y <= top + size - 1; y++)
	{
		x_size--;
		for (int x = right; x >= right - x_size; x--)
		{
			PutPixel(x, y, c);
		}
	}
...
void Graphics::DrawRightIsoTriLL(int bottom, int left, int size, Color c)
{
	int x_size = size;
	for (int y = bottom; y >= bottom - size + 1; y--)
	{
		x_size--;
		for (int x = left; x <= left + x_size; x++)
		{
...
void Graphics::DrawRightIsoTriLR(int bottom, int right, int size, Color c)
{
	int x_size = size;
	for (int y = bottom; y >= bottom - size + 1; y--)
	{
